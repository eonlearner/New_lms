...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', image: Check, 	imgClass:'',	 title: 'Groups', number:'1', svgicon: <RightIcon />, },
...
const AdmGroupReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Group Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              ...
              <Table responsive>
                <thead>
                  <tr>
                    ...
                    <th></th>
                    <th>
                      <strong>NUMBER OF TRAINING</strong>
                    </th>
                  </tr>
                </thead>
                <tbody>
