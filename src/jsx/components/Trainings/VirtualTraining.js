              ...
              <Table responsive>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Hitesh</td>
                    <Link to="/users-list"><td><i class="bi bi-play-circle-fill"></i></td></Link>
                    <td>5</td>
                    <td>-</td>
                    ...
                    <td>
                      <Dropdown>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item href="/edit-virtual-trainings"><i class="bi bi-pencil-square">  &nbsp;</i>Edit</Dropdown.Item>
