...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', image: Check, 	imgClass:'',	 title: 'Learners', number:'2', svgicon: <RightIcon />, },
	{ coloumClass:'col-sm-6',	  image: Bookmarks,	imgClass:'bookmarks', title: 'Course Assigments', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary',   image: Bulb, 		imgClass:'bulb',	title: 'Completed Courses', number:'0', svgicon: <BulbIcon /> },
	{ coloumClass:'col-sm-6',	  image: Bookmarks,	imgClass:'bookmarks', title: 'Course in Progress', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary',   image: Bulb, 		imgClass:'bulb',	title: 'Training Time', number:'0h0m', svgicon: <BulbIcon /> }
];
...
const UserReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="User Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
