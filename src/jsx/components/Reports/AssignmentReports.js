...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', imgClass:'', title: 'Assignments', number:'0', svgicon: <RightIcon />, },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Submissions', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary', image: Bulb,	imgClass:'Passed',	title: 'Passed', number:'0', svgicon: <BulbIcon /> },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Average Grade', number:'_', svgicon: <BookIcon /> },
...
const AssignmentReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Assignment Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
