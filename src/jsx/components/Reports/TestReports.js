...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', imgClass:'', title: 'Scorms', number:'9', svgicon: <RightIcon />, },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Attempts', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary', image: Bulb,	imgClass:'Passed',	title: 'Completed Courses', number:'0', svgicon: <BulbIcon /> },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Average Score', number:'_', svgicon: <BookIcon /> },
...
const TestReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Test Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
