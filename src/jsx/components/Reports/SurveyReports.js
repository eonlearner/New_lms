...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', imgClass:'', title: 'Survey', number:'1', svgicon: <RightIcon />, },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Initiations', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary', image: Bulb,	imgClass:'Passed',	title: 'Completions', number:'0', svgicon: <BulbIcon /> },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Average duration', number:'_', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-primary', image: Bulb,	imgClass:'bulb',	title: 'Last activity', number:'_', svgicon: <BulbIcon /> }
];
...
const SurveyReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Survey Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
          ...
          <img src={item.image} alt="" className={item.imgClass} />
              ...
              <Table responsive className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    <td>Sample</td>
                    <td>Advanced Features of LMS</td>
                    <td>-</td>
                    <Link to="/survey-overview"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-graph-up"></i></td></Link>
                    <td></td>
                  </tr>
                </tbody>
              </Table>
