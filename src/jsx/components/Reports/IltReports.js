...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', imgClass:'', title: 'ILT', number:'0', svgicon: <RightIcon />, },
	{ coloumClass:'col-sm-6', image: Bookmarks,	imgClass:'bookmarks', title: 'Registration', number:'0', svgicon: <BookIcon /> },
...
const IltReports = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Ilt Reports" motherMenu="Overview" />
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
